...
function NavbarFixed() {
  ...
  return (
    <motion.div
      ...
      className="fixed z-[999] top-2 left-1/2 -translate-x-1/2 rounded-xl p-2 flex-col  backdrop-blur-lg border border-balck justify-around flex md:flex-row items-center"
