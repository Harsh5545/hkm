...
import game from "/course/2d-animation-overlay.webp";
import Gamer from "/course/2d-animation-image.webp";
import ArrowRightIcon from "@mui/icons-material/ArrowRight";
import AnimationBackground from "/course/2d-animation-bg.webp";
...
import WUL from "/course/animationpgs.webp";
import AOS from "aos";
...
function Animation2D() {
  ...
  const backgroundStyles = {
    backgroundImage: `url(${AnimationBackground})`, // Use backticks for string interpolation
        ...
        <div className="mb-8y h-[100vh] flex md:flex-row flex-col-reverse justify-center items-center">
          ...
          >
            ...
            <p
              ...
              style={{ color: "white" }}
            >
              2D animation refers to the cre- ation of moving images by
              displaying a sequence of indi- vidual frames in a two-dimen-
              sional space. 2D animation is focused on flat, two-dimensional
              surfaces.
            </p>{" "}
            <p
            ...
            >
              {" "}
              It's a traditional form of animation that has been used in various
              mediums such as car- toons, films, video games, and
              advertisements.
            </p>
          </div>
        </div>
      ...
      <div className=" p-4 flex flex-col md:flex-row h-[100vh] md:h-[60vh] justify-center items-center">
        ...
        >
          ...
          <p className="text-lg md:text-2xl text-center">
            Harikrushna Multimedia Certified Expert in 2D Animation
          </p>
        </div>
      </div>
