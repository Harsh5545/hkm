  ...
  return (
    <div className=" font-poppins overflow-hidden mx-auto">
        ...
        <div className="mb-8y h-[100vh] flex md:flex-row flex-col-reverse justify-center items-center">
          ...
          >
            ...
            <p
              ...
              style={{ color: "white" }}
            >
              Enrolling in the Graphics & Animation course at Harikrushna
              Multimedia empowers you to excel in Graphics Design, Motion
            ...
            <p
              ...
              style={{ color: "white" }}
            >
              This intensive program thoroughly acquaints you with a variety of
              design elements. The curriculum includes digital design, page
              layout, video editing, and 3D animation.{" "}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className=" p-4 flex flex-col md:flex-row h-[100vh] md:h-[60vh] justify-center items-center">
        ...
        >
          ...
          <p className="text-lg md:text-2xl text-center">
            Harikrushna Multimedia Certified Expert in Graphics & Animation
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 px-8 justify-center md:flex-row flex-col md:gap-1 gap-14 items-center my-20">
        ...
        <div
          data-aos="flip-left"
          className="md:col-span-1 flex gap-5 justify-end items-center flex-col animate-fadeIn"
        >
          ...
          <img
            ...
            width={400}
            src={Like}
            alt="Harikrushna Multimedia eligibility criteria"
          />
        ...
        >
          ...
          <img
            ...
            width={400}
            src={Job}
            alt="harikrushna Multimedia job guarantee"
          />
          <p className="w-full md:w-[60%] text-md md:text-xl text-center">
