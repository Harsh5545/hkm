...
import VideoPNG from "/course/videoPagePNG.webp";
import VideoEdit from "/course/videoEditings.webp";
import ArrowRightIcon from "@mui/icons-material/ArrowRight";
import GamePage from "/course/VideoEditingbg.webp";
...
import VideoWYL from "/course/Video-files.webp";
import AOS from "aos";
        ...
        <div className="mb-8y h-[100vh] flex md:flex-row flex-col-reverse justify-center items-center">
          ...
          >
            ...
            <p
              ...
              style={{ color: "white" }}
            >
              Video editing is the art of arranging video footage, audio, and
              effects to create a captivating final video. It includes selecting
              and trimming clips, adding transitions, titles, and effects,
              adjusting colors and audio, and rendering the
            </p>
          </div>
        </div>
      </div>
      ...
      <div className=" p-4 flex flex-col md:flex-row h-[100vh] md:h-[60vh] justify-center items-center">
        ...
        >
          ...
          <p className="text-lg md:text-2xl text-center">
            Harikrushna Multimedia Certified Expert in Video Editing
          </p>
        </div>
      </div>
